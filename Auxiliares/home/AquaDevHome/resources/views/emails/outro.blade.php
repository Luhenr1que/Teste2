        ...
        <tr>
            <td align="center">
                <table class="row-content" width="600" style="background-color:#fdfdfd; border:2px solid #000;">
                    ...
                    <tr>
                        <td style="border-top:2px solid #000000ff;"></td>
                    </tr>
                    <tr>
                        <td align="center" style="padding:20px; color:#000; font-size:28px; font-weight:bold;">
                            Outro Assunto
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="border-top:2px solid #000000ff; padding:10px;" align="center">
