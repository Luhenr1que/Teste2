        ...
        <tr>
            <td align="center">
                <table width="600" style="background-color:#fdfdfd; border:2px solid #000;">
                    ...
                    <tr>
                        <td style="border-top:2px solid #5000dbff;"></td>
                    </tr>
                    <tr>
                        <td align="center" style="padding:20px; color:#5000dbff; font-size:28px; font-weight:bold;">
                            Sugestão Recebida
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="border-top:2px solid #5000dbff; padding:10px;" align="center">
